...
@section('customer')
            ...
            <div class="modal-content overflow-hidden border-0">
                ...
                <div class="modal-body p-0">
                    <div class="row align-items-stretch">
                        <div class="col-lg-6 p-lg-0"><a id="bg_imgProduct" class="glightbox product-view d-block h-100 bg-cover bg-center"
                                style="background: url(img/product-5.jpg)" href="img/product-5.jpg" data-gallery="gallery1"
                                data-glightbox="Red digital smartwatch"></a><a id="img1" class="glightbox d-none"
                                href="img/product-5-alt-1.jpg" data-gallery="gallery1"
                                data-glightbox="Red digital smartwatch"></a><a id="img2" class="glightbox d-none"
                        ...
                        <div class="col-lg-6">
                            <div class="p-4 my-md-4">
                                ...
                                <h2 class="h4" id="nameProduct">Red digital smartwatch</h2>
                                <p class="text-muted" id="priceProduct">$250</p>
                                <p class="text-sm mb-4" id="desProduct">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut
                                    ...
                                    <div class="product text-center">
                                        <div class="mb-3 position-relative">
                                            <div class="badge text-white bg-"></div><a class="d-block"
                                                href="{{ route('User.detailprod', ['id' => $item->id]) }}"><img
                                                    class="img-fluid
                                                w-100 rounded"
                                                    style="max-height: 400px" src="{{ Storage::url($item->image) }}"
                                                    alt="..."></a>
                                            <div class="product-overlay">
                                                <ul class="mb-0 list-inline">
                                                    ...
                                                    <li class="list-inline-item mr-0"><a
                                                            class="product-link btn btn-sm btn-outline-dark"
                                                            data-item="{{ json_encode($item) }}" href="#productView"
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Lấy tất cả các phần tử có class "product-link"
            var productLinks = document.querySelectorAll(".product-link");

            // Lặp qua mỗi phần tử sản phẩm và thêm sự kiện click
            productLinks.forEach(function(productLink) {
                productLink.addEventListener("click", function(event) {
                    event.preventDefault(); // Ngăn chặn hành động mặc định của thẻ 'a'
                    var bg_imgProduct = document.getElementById('bg_imgProduct');
                    ...
                    // Lấy ra thông tin item từ thuộc tính 'data-item'
                    var itemData = JSON.parse(this.getAttribute("data-item"));

                    // Hiển thị thông tin item (có thể thực hiện các thao tác khác với thông tin này)
                    var imagePath = "/storage/" + itemData.image;
                    var cleanedImagePath = imagePath.replace('/public', '');
                    bg_imgProduct.style.backgroundImage = "url('"+cleanedImagePath+"')";
                    bg_imgProduct.href = cleanedImagePath;
                    img1.href = cleanedImagePath;
                    img2.href = cleanedImagePath;
                    desProduct.innerText = itemData.description;
                    nameProduct.innerText = itemData.name;
                    priceProduct.innerText = itemData.price;
